...
const forms = state => {
  const form = document.querySelectorAll("form"),
        ...
        closeTrigger = document.querySelector(".popup_calc_end_close");
...
const images = () => {
  ...
  workSection.addEventListener("click", e => {
    ...
    if (target && (target.matches("div.popup > img") || target.matches("div.popup"))) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(item => {
      item.addEventListener("click", e => {
        ...
        if (!("form" in state) && getComputedStyle(document.querySelector(".popup_calc")).display === "block") {
