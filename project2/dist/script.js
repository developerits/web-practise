...
/* harmony import */ var wowjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! wowjs */ "./node_modules/wowjs/dist/wow.js");
/* harmony import */ var wowjs__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(wowjs__WEBPACK_IMPORTED_MODULE_13__);
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var wow = new wowjs__WEBPACK_IMPORTED_MODULE_13__["WOW"]({
    live: false
  });
  wow.init();
  ...
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])("a[href=\"#styles\"]");
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])("a[href=\"#portfolio\"]");
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])("a[href=\"#often-questions\"]");
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])("a[href=\"#scheme\"]");
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])("a[href=\"#footer\"]");
...
var calc = function calc() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return regeneratorRuntime.awrap(Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])("http://localhost:3000/calculate"));
  ...
  var setValues = function setValues(id, i) {
  ...
  var calcFunc = function calcFunc() {
    var sum = 0;
    sum = Math.round(+ +sizeBlock.getAttribute("value") * +materialBlock.getAttribute("value") + +optionsBlock.getAttribute("value"));
    console.log(sum);

    if (sizeBlock.getAttribute("value") == 0 || materialBlock.getAttribute("value") == 0) {
      resultBlock.textContent = "Пожалуйста, выберете размер и метериал картины";
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener("drop", function (e) {
      ...
      var name = "".concat(arr[0].substring(0, 6)).concat(dots).concat(arr[1]);
...
var filter = function filter() {
  ...
  var bindBtnToEventClick = function bindBtnToEventClick(btnSelector) {
    var markSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      try {
        ...
        formData.append("calc-price", document.querySelector(".calc-price").textContent);
      } catch (error) {
        console.log(error);
      }

      var api;
      item.closest(".popup-design") || item.querySelector(".file_upload") ? api = path.designer : api = path.question;
      console.log(api);
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    var matrix = "+7 (___) ___ __ __",
        ...
        // 7 из матрицы
    val = this.value.replace(/\D/g, ""); // строка из value

    if (def.length >= val.length) {
      val = def;
    }

    console.log("def:".concat(def, "  val:").concat(val));
...
var modals = function modals(state) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener("click", function (e) {
        ...
        btnPressed = true; // console.log(document.querySelector(".popup_calc_button"));
        // if (
        //   !("form" in state) &&
  ...
  function openByScroll(selector) {
    window.addEventListener("scroll", function () {
      ...
      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeight - 50) {
...
var scrolling = function scrolling(Selector) {
  ...
  var bindCalcScroll = function bindCalcScroll(elem) {
  ...
  var smoothScroll = function smoothScroll(from, to, hash) {
    ...
    var move = setInterval(function () {
      ...
      if (prevScrollTop === scrollTop || to > from && scrollTop >= to || to < from && scrollTop <= to) {
        console.log("\u041E\u0434\u0438\u043D \u0442\u0438\u043A: prevScroll: ".concat(prevScrollTop, " scrollTop: ").concat(scrollTop, " to: ").concat(to, " from: ").concat(from));
        clearInterval(move);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(response) {
    ...
    if (response instanceof Error) {
      ...
      console.log("Error");
      card.textContent = "\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438: ".concat(response.message);
    ...
    response.forEach(function (_ref) {
      var src = _ref.src,
          ...
          link = _ref.link;
      var card = document.createElement("div");
      card.classList.add("col-sm-3", "col-sm-offset-0", "col-xs-10", "col-xs-offset-1", "animate__animated", "animate__fadeInUp");
